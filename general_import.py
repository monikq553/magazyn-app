...
ENTITY_FIELDS = {
    ...
    "issue": (
        ...
        "contractor", "date", "doc_number", "movement_type", "dimension",
        "species", "notes",
    ),
...
ALIASES = {
    ...
    "dimension": {"dimension", "wymiar", "wymiary", "format"},
    "species": {"species", "gatunek", "rodzaj drewna"},
    "notes": {"notes", "uwagi", "opis", "komentarz"},
